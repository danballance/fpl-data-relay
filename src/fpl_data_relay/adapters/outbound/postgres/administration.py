"""Outbound PostgreSQL adapter for destructive administration."""
...
class PostgresDatabaseRecreator:
    """Database recreation adapter backed by an asyncpg maintenance connection."""
