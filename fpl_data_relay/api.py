...
from fpl_data_relay.api_models import (
...
NOT_INGESTED_RESPONSE: dict[int | str, dict[str, Any]] = {
    503: {
        "model": ErrorResponse,
        "description": "The requested data has not been ingested yet.",
    },
}
INVALID_LAST_EVENT_ID_RESPONSE: dict[int | str, dict[str, Any]] = {
    400: {
...
def create_app(
    *,
    ...
    async def require_season(*, season_id: str) -> Season:
        ...
        season = await typed_store.get_season(season_id=season_id)
        if season is None:
    ...
    async def list_seasons() -> list[Season]:
        ...
        return await typed_store.list_seasons()
    ...
    async def current_season() -> Season:
        ...
        season = await typed_store.get_current_season()
        if season is None:
    ...
    async def list_events(
        ...
        return await typed_store.list_events(season_id=season_id)
    ...
    async def current_event(
        ...
        await require_season(season_id=season_id)
        event = await typed_store.get_current_event(season_id=season_id)
        if event is None:
    ...
    async def get_event(
        ...
        await require_season(season_id=season_id)
        event = await typed_store.get_event(season_id=season_id, event_id=event_id)
        if event is None:
    ...
    async def list_phases(
        ...
        await require_season(season_id=season_id)
        return await typed_store.list_phases(season_id=season_id)
    ...
    async def list_teams(
        ...
        await require_season(season_id=season_id)
        return await typed_store.list_teams(season_id=season_id)
    ...
    async def get_team(
        ...
        await require_season(season_id=season_id)
        team = await typed_store.get_team(season_id=season_id, team_id=team_id)
        if team is None:
    ...
    async def list_element_types(
        ...
        await require_season(season_id=season_id)
        return await typed_store.list_element_types(season_id=season_id)
    ...
    async def list_elements(
        ...
        await require_season(season_id=season_id)
        return await typed_store.list_elements(season_id=season_id)
    ...
    async def get_element(
        ...
        await require_season(season_id=season_id)
        element = await typed_store.get_element(
            season_id=season_id,
    ...
    async def list_fixtures(
        ...
        await require_season(season_id=season_id)
        return await typed_store.list_fixtures(season_id=season_id, event_id=None)
    ...
    async def list_event_fixtures(
        ...
        await require_season(season_id=season_id)
        return await typed_store.list_fixtures(
            season_id=season_id,
            event_id=event_id,
        )
    ...
    async def event_status(
        ...
        await require_season(season_id=season_id)
        status = await typed_store.get_event_status(season_id=season_id)
        if status is None:
    ...
    async def list_live_elements(
        ...
        await require_season(season_id=season_id)
        return await typed_store.list_live_elements(
            season_id=season_id,
            event_id=event_id,
        )
